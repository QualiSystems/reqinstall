...
def main():
    ...
    local_group = arguments.add_argument_group(title="Local repository group")
    log_group = arguments.add_argument_group(title="Logging group")
    ...
    log_group.add_argument('--log', '-l', dest="log", required=False, help="Log path")
    ...
    local_group.add_argument('--local-path', '-lp', dest='local_path',
                             help="Path to folder containing packages locally")
